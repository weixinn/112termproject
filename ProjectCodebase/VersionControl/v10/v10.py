...
HOST = "128.237.196.230" # put your IP address here if playing on multiple computers
PORT = 50003
...
# from last try, added settings, win screens and draw score, fixed small parts
# e.g. switching turns and adding max num power ups
# things to do: - clean up code
#               - sockets

# what to do NOW: - sockets
