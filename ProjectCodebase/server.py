'''
This file contains the framework to set up the server and needs to be run from the
computer's terminal.

Reference:
Written by Rohan Varma, adapted by Kyle Chin for 15-112 Sockets Optional Lecture
'''
...
HOST = "192.168.0.178" # put your IP address here if playing on multiple computers
PORT = 50003
BACKLOG = 4
